...
const Sidebar = ({ isOpen, toggleSidebar, isCollapsed }) => {
  ...
  return (
    <>
      {/* Sidebar */}
      <div
        className={`fixed lg:relative top-0 left-0 h-[-webkit-fill-available] overflow-y-auto bg-gray-100 border-r-2 border-gray-100 transition-all duration-300 ease-in-out z-50 p-3 flex flex-col justify-between
